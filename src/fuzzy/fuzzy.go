...
func process(a, b, c, d *fuzzybool.FuzzyBool) {
	...
	fmt.Println("0.And(.25):", a.And(b), "; .25.And(.75)", b.And(c), "; .75.And(1):", c.And(d), "; .25.And(.75, 1):", b.And(c, d), ";\n")
	fmt.Println("0.Or(.25):", a.Or(b), "; .25.Or(.75)", b.Or(c), "; .75.Or(1):", c.Or(d), "; .25.Or(.75, 1):", b.Or(c, d), ";\n")
